...
1. Cloná el repositorio git clone https://github.com/cvanessa-dev/ticket-system.git
2. Abrí la carpeta en VS Code
3. Abrí el archivo `Index.html` con la extensión Live Server para visualizarlo en el navegador

## Estado del proyecto

En desarrollo. Algunas funcionalidades aún están en construcción.
...
### Técnicos
![Técnicos](screenshots/Tecnicos.png)
